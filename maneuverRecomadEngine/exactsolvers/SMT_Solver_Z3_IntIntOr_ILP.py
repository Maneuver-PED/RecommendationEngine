from z3 import *
from maneuverRecomadEngine.exactsolvers.SMT_Solver_Z3_ILP import Z3_Solver_Int_Parent_ILP


class Z3_SolverIntIntInt(Z3_Solver_Int_Parent_ILP):#ManeuverProblem):
